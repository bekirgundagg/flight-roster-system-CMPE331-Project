...
class FlightAdmin(admin.ModelAdmin):
    # Alan isimlerini modelinize göre güncelledik
    list_display = (
        'flight_number',
        'departure_datetime',
        'source',
    ...
    # --- YENİ EKLENEN ÖZELLİK: Çoklu Seçim Kutusu ---
    # Pilot ve Kabin ekibini seçerken Ctrl'ye basılı tutmak yerine
    # soldan sağa atabileceğin şık bir arayüz sağlar.
